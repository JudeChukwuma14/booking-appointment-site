          ...
          {ProductData.map((item) => (
            ...
            >
              <div className="relative h-72 bg-slate-100 overflow-hidden transition-all duration-300 ease-out hover:scale-105 cursor-pointer">
                ...
                <div className="absolute top-4 right-4 bg-white text-green-900 px-3 py-1 rounded-full font-bold flex items-center gap-1">
              ...
              <div className="p-6">
                ...
                <span className="inline-block mt-2 text-gray-700 py-1 text-sm font-bold">
                  {item.role}
                </span>

                <div className="border-t border-gray-300 mt-4 p-2 space-y-3 bg-blue-100 rounded-lg">
                  <p className="flex items-center gap-3 text-gray-700">
                    <CalendarCheck size={18} className="text-green-900" />

                    <b className="text-black">{item.nextAvailable}</b>
                  </p>
                </div>
                ...
                <div className="mt-5">
                  <button
                    onClick={() =>
                      console.log(`Book Consultation for ${item.name}`)
                    }
                    className="w-full text-center bg-primary-700 text-white px-6 py-3 rounded-md font-semibold cursor-pointer transition-colors duration-200 hover:bg-[#EEF2F6] hover:text-primary-700 hover:border hover:border-primary-700"
                  >
                    Book Consultation
                  </button>
                </div>
