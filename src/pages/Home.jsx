  ...
  <div className="grid gap-6 lg:grid-cols-[1.7fr_1fr]">
    <div className="flex flex-col gap-6 justify-start bg-amber-50 px-6 py-8 rounded-lg shadow-lg">
      ...
      <p className="text-start">
        Describe how you're feeling and we'll suggest the right department for
        you.
      </p>
      ...
      <p className="text-sm text-gray-500 mt-2">Recommended departments</p>
    ...
    <div className="grid gap-6">
      ...
      <div className="bg-gray-500 text-white rounded-lg shadow-lg p-6">
        ...
        <p className="text-[#EEF2F6]">Access results, billings and history.</p>
        <button
...
<div className="container mx-auto px-4 py-8">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
    <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
      ...
      <h3 className="text-xl font-bold text-primary-700 mb-2">Cardiology</h3>
    ...
    <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
      ...
      <h3 className="text-xl font-bold text-primary-700 mb-2">Pediatrics</h3>
      <p className="text-gray-600">
    ...
    <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
      ...
      <h3 className="text-xl font-bold text-primary-700 mb-2">Neurology</h3>
      <p className="text-gray-600">
    ...
    <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
      ...
      <h3 className="text-xl font-bold text-primary-700 mb-2">Oncology</h3>
      <p className="text-gray-600">
...
<div className="container mx-auto px-4 py-12 rounded-2xl bg-[#EEF2F6] mt-8 mb-8">
  ...
  <p className="text-start text-gray-600 mb-12 max-w-3xl">
    Access test results, request prescription refills, and message your doctor
    securely through our HIPAA-compliant Patient Portal.
  </p>
